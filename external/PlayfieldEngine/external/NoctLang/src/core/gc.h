...
#elif defined(NOCT_TARGET_PSVITA)
#define RT_GC_DEFAULT_NURSERY_SIZE		(4 * 1024 * 1024)
#define RT_GC_DEFAULT_GRADUATE_SIZE		(1 * 1024 * 1024)
#define RT_GC_DEFAULT_TENURE_SIZE		(32 * 1024 * 1024)
