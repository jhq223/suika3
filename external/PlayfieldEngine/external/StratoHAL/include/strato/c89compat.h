...
#if TARGET_OS_IPHONE
#define HAL_TARGET_IOS
#elif TARGET_OS_OSX
#define HAL_TARGET_MACOS
#endif
#endif
#endif
#endif
...
#define HAL_TARGET_ANDROID
#endif

/* Wasm (Emscripten) */
#if defined(__EMSCRIPTEN__)
#define HAL_TARGET_WASM
#endif
 ...
 * Byteorder
 */
#if defined(HAL_ARCH_LE)

static INLINE uint64_t hal_host_to_le_64(uint64_t d) {
	return d;
}
static INLINE uint32_t hal_host_to_le_32(uint32_t d) {
	return d;
}
static INLINE uint16_t hal_host_to_le_16(uint16_t d) {
	return d;
}
static INLINE uint64_t hal_le_to_host_64(uint64_t d) {
	return d;
}
static INLINE uint32_t hal_le_to_host_32(uint32_t d) {
	return d;
}
static INLINE uint16_t hal_le_to_host_16(uint16_t d) {
	return d;
}
static INLINE uint64_t hal_be_to_host_64(uint64_t d) {
	return ((d & 0xff) << 56) |
		(((d >> 8) & 0xff) << 48) |
		(((d >> 16) & 0xff) << 40) |
		(((d >> 24) & 0xff) << 32) |
...
static INLINE uint32_t hal_be_to_host_32(uint32_t d) {
	return ((d & 0xff) << 24) |
		(((d >> 8) & 0xff) << 16) |
		(((d >> 16) & 0xff) << 8) |
		((d >> 24) & 0xff);
}
static INLINE uint16_t hal_be_to_host_16(uint16_t d) {
	return (uint16_t)(((uint32_t)(d & 0xff) << 8) |
			  ((d >> 8) & 0xff));
}
static INLINE uint64_t hal_host_to_be_64(uint64_t d) {
	return ((d & 0xff) << 56) |
		(((d >> 8) & 0xff) << 48) |
		(((d >> 16) & 0xff) << 40) |
		(((d >> 24) & 0xff) << 32) |
...
static INLINE uint32_t hal_host_to_be_32(uint32_t d) {
	return ((d & 0xff) << 24) |
		(((d >> 8) & 0xff) << 16) |
		(((d >> 16) & 0xff) << 8) |
		((d >> 24) & 0xff);
}
static INLINE uint16_t hal_host_to_be_16(uint16_t d) {
	return (uint16_t)(((uint32_t)(d & 0xff) << 8) |
			  ((d >> 8) & 0xff));
}
